...
data_argmented_pro = torch.load('data\\data3.pt')

# Combine the datasets
combined_dataset = data + data_argmented + data_argmented_pro

random.shuffle(combined_dataset)
torch.save(combined_dataset, os.path.join(save_dir, 'data_all.pt'))
